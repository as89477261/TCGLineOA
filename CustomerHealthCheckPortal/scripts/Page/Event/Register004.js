...
function ValidateStep1() {
    ...
    var txtEmployeeCode = document.getElementById("txtEmployeeCode");
    ...
    if (txtEmployeeCode != null) {
        if (txtEmployeeCode.value === "") {
            txtEmployeeCode.style.border = "1px solid #CF0A0A";
            result = false;
        } else {
            txtEmployeeCode.style.border = "";
        }
    }
...
function GenerateFormObj() {
    ...
    var Obj = {
        ...
        Q1: document.getElementById("txtEmployeeCode").value,
