...
function KeepDataAndFinish() {
    ...
    var result = InsertFormEventRegisterDynamicNoSendMail(obj);
...
function ValidateStep1() {
    ...
    var ddlEventBranch = document.getElementById("ddlEventBranch");
    var txtPhoneNumber = document.getElementById("txtPhoneNumber");
    //console.log(ddlEventBranch);




    if (ddlEventBranch != null) {
        if (ddlEventBranch.value === "") {
            ddlEventBranch.style.border = "1px solid #CF0A0A";
            result = false;
        } else {
            ddlEventBranch.style.border = "";
        }
    }
    ...
    if (txtPhoneNumber != null) {
        if (txtPhoneNumber.value === "") {
            txtPhoneNumber.style.border = "1px solid #CF0A0A";
            result = false;
        } else {
            txtPhoneNumber.style.border = "";
        }
    }
...
function GenerateFormObj() {
    ...
    console.log('eventID : CODE ', eventID);
    var uid = getCookie("uid");
    ...
    var Obj = {
        ...
        EventCode: eventID,
        BusinessType: '-',
        BusinessName: 'พร้อมช่วย',
        FirstName: document.getElementById("txtFirstName").value,
        LastName: document.getElementById("txtLastName").value,
        Phone: '-',
        Email: '-',

        //Q1: document.getElementById("txtEventCode").value,
        //Q2: document.getElementById("txtFirstName").value,
        //Q3: document.getElementById("txtLastName").value,
        //Q4: document.getElementById("ddlEventBranch").value

        Q1: document.getElementById("ddlEventBranch").value,
        Q2: document.getElementById("txtIDCard").value,
        Q3: document.getElementById("txtFirstName").value,
        Q4: document.getElementById("txtLastName").value,
        Q5: document.getElementById("txtPhoneNumber").value,
        Q6: document.getElementById("txtCodeEvent").value
