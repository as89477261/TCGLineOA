<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true"
    CodeBehind="info.aspx.cs" Inherits="CustomerHealthCheck.views.PDPA.index" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>TCG OneStopService - PDPA Consent</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <asp:HiddenField ID="hddIsDebug" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hddLiffKey" runat="server" ClientIDMode="Static" />
    <asp:HiddenField ID="hddIsHttpManagerDubug" runat="server" ClientIDMode="Static" />
    ...
    <asp:HiddenField ID="hddPDPACondsentPoint" runat="server" ClientIDMode="Static" />
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="#" 
                                    ...
                                    class="btn btn-full gradient-gray rounded-s shadow-bg shadow-bg-s">ยินยอม
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="#" 
                                    id="btnStep1No" onclick="Step1Consent(0)"
                                    class="btn btn-full gradient-gray rounded-s shadow-bg shadow-bg-s">ไม่ยินยอม
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <asp:Button
                                    ...
                                    runat="server"
                                    ClientIDMode="Static"
                                    OnClientClick="CheckConsentIsActive() ; return false"
