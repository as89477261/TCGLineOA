<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master"
    AutoEventWireup="true" CodeBehind="merchant_Scan_KM.aspx.cs" Inherits="CustomerHealthCheck.merchant_Scan_KM" %>
        ...
        <div class="page-content footer-clear">
            ...
            <div class="card card-style">
                <div class="content" style="text-align:center;">
                    <img src="images/logos/s1.jpg" style="width: 80%; text-align: center;margin-bottom:10px;" />
                    <div class="row mb-3 mt-4">
                        <h5 class="col-4 text-start font-15">ร้านค้า</h5>
                        <h5 class="col-8 text-end font-14 opacity-60 font-400">ไก่ย่าง 5 ดาว</h5>
                        <h5 class="col-4 text-start font-15">คูปอง</h5>
                        <h5 class="col-8 text-end font-14 font-400"><span class="bg-green-dark px-2 rounded-s">ส่วนลด 50 บาท</span></h5>
                        <h5 class="col-4 text-start font-15">วันเวลาทำรายการ</h5>
                        <h5 class="col-8 text-end font-14 opacity-60 font-400">29/10/2567 12.00 น</h5>
                        <h5 class="col-4 text-start font-15">ผุ้ใช้งานคูปอง</h5>
                        <h5 class="col-8 text-end font-14 opacity-60 font-400">ไอดี 1234</h5>
                        <h5 class="col-4 text-start font-15">สถานที่ใช้งาน</h5>
                        <h5 class="col-8 text-end font-14 opacity-60 font-400">ไก่ 5 ดาวสาขาชาญอิสระ</h5>
            ...
            <script src="http://localhost:56955/scripts/KM/html5-qrcode.min.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    <script src="<%= ResolveClientUrl("~/scripts/KM/Menu_KM.js") + "?v="+DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
