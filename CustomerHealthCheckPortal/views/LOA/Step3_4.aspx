<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Step3_4.aspx.cs"
    Inherits="CustomerHealthCheck.views.LOA.Step3_4" %>
                ...
                <div class="row" id="step1">
                    ...
                    <div class="col-12">
                        <div class="content m-0">
                            <div class="row" style=" padding: 10px; margin-top: 20px; border-radius: 10px; overflow-x: scroll; margin-bottom: 20px;">

                                <h2 class="">ท่านได้ทำรายการ ยืนยันตัวตนสำเร็จ</h2>
                                <p>
                                    กำลังนำท่านกลับเข้าสู่ กลับเข้าสู่ไลน์ TCG  
                                </p>
                                    </div>
