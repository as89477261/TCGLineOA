<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Step2_BK.aspx.cs"
    Inherits="CustomerHealthCheck.views.LOA.Step2_BK" %>
    ...
    <div id="page" style="z-index: 1;">
        ...
        <div class="page-content footer-clear" style="padding: 0px !important;">
            ...
            <div class="card card-style px-2 py-2" id="pnlSignUpForm">
                ...
                <div class="accordion accordion-m border-0" id="accordion-group-1">
                    ...
                    <div class="accordion-item card card-style ms-n3 ps-3" style="background-image: linear-gradient(rgb(93,156,236),rgb(74,137,220)) !important; border-radius:20px; padding: 5px !important; margin: 0px!important;">
                        <button class="accordion-button px-0 ps-1 rounded-xs" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-1" aria-expanded="true">
                                ...
                                <div>
                                    <%--<h4 class="mb-n1 opacity-50" style="color: azure">สถานะปัจจุบัน (2/9)</h4>--%>
                                    <h3 class="pt-1 mb-n1 opacity-80" style="color: azure">ข้อมูลส่วนตัว (2/9)</h3>
                                </div>
                                <div class="">
                ...
                <div class="content accordion-collapse collapse content collapse show" data-bs-parent="#accordion-group-1" id="accordion1-1">
                    <%--<h3 class="mb-0 mt-2 font-22">ข้อมูลส่วนตัว</h3>--%>
                        ...
                        <div class="col-12">
                            <div class="content m-0">
                                ...
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtFirstName" placeholder="โปรดระบุชื่อ" value="ทดสอบ">
                                    <label for="txtFirstName" class="form-label-always-active color-highlight">ชื่อ</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtLastName" placeholder="โปรดระบุนามสกุล" value="ระบบ">
                                    <label for="txtLastName" class="form-label-always-active color-highlight">นามสกุล</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtIDCard" placeholder="โปรดระบุเลขบัตรประจำตัวประชาชน" value="898xxxxx54123">
                                    <label for="txtIDCard" class="form-label-always-active color-highlight">เลขบัตรประจำตัวประชาชน</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtLaserID" placeholder="โปรดระบุรหัสหลังบัตรประจำตัวประชาชน" value="TCG1525854">
                                    <label for="txtLaserID" class="form-label-always-active color-highlight">รหัสหลังบัตรประจำตัวประชาชน</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="text" class="form-control rounded-xs datepicker-th" id="txtBirthDate" placeholder="วันเดือนปีเกิด" value="23/10/2542" maxlength="10" onkeypress="filterDigits(event)">
                                    <label for="txtBirthDate" class="color-highlight form-label-always-active">วันเกิด</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtPhone" placeholder="โปรดระบุเบอร์มือถือ" maxlength="10" value="088xxx2545">
                                    <label for="txtPhone" class="color-highlight form-label-always-active">เบอร์มือถือ</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input autocomplete="off" type="email" class="form-control rounded-xs" id="txtEmail" placeholder="โปรดระบุอีเมล์" value="TCG@gmail.com">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <a href="#" onclick="redirectToLOAStep0()" class="btn btn-full mx-1 gradient-red shadow-bg shadow-bg-xs ">ย้อนกลับ</a>
                                    </div>
                                    <div class="col-6">
                                        <a href="#" id="btnSubmit" onclick="redirectToLOAStep4()" class="btn btn-full mx-1 gradient-blue shadow-bg shadow-bg-xs">ถัดไป</a>
                ...
                <div class="modal-dialog modal-dialog-centered modal-l">
                    <div class="modal-content" id="modalContent2">
                        ...
                        <div class="modal-footer" style="justify-content: center;">
                            ...
                            <a href="#" onclick="redirectToLOAStep3()"
