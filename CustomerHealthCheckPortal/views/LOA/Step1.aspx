<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Step1.aspx.cs"
    Inherits="CustomerHealthCheck.views.LOA.Step1" %>
        ...
        <div id="page">
            ...
            <div class="card card-style px-2 py-2">
                <div class="accordion accordion-m border-0" id="accordion-group-1">
                    <div class="accordion-item card card-style ms-n3 ps-3" style="background-image: linear-gradient(rgb(93,156,236),rgb(74,137,220)) !important; border-radius: 20px; padding: 5px !important; margin: 0px!important;">
                        <button class="accordion-button px-0 ps-1 rounded-xs" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-1" aria-expanded="true">
                            <div class="px-0 ps-1 rounded-xs">
                                <div>
                                    <%--<h5 class="mb-n1 opacity-50" style="color: azure">(1/9)</h5>--%>
                                    <h3 class="pt-1 mb-n1 opacity-80" style="color: azure">เงื่อนไขการใช้บริการ (1/9)</h3>
                                </div>
                                <div class="">
                    ...
                    <div class="accordion-collapse collapse card card-style collapse show " data-bs-parent="#accordion-group-1" id="accordion1-1">
                        ...
                        <br />
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="#" onclick="redirectToLOAStep0()" class="btn btn-full mx-1 gradient-blue shadow-bg shadow-bg-xs">ถัดไป</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    <script src="<%= ResolveClientUrl("~/scripts/Page/LOA/Step1.js") + "?v=" + DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
