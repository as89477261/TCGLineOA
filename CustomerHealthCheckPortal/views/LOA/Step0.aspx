<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Step0.aspx.cs" Inherits="CustomerHealthCheck.views.LOA.Step0" %>
                ...
                <div class="accordion accordion-m border-0" id="accordion-group-1">
                    <div class="accordion-item card card-style ms-n3 ps-3" style="background-image: linear-gradient(rgb(93,156,236),rgb(74,137,220)) !important; border-radius: 20px; padding: 5px !important; margin: 0px!important;">
                        <button class="accordion-button px-0 ps-1 rounded-xs" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-1" aria-expanded="true">
                            <div class="px-0 ps-1 rounded-xs">
                                <div>
                                    <%--<h5 class="mb-n1 opacity-50" style="color: azure">สถานะปัจจุบัน (2/9)</h5>--%>
                    ...
                    <div class="accordion-collapse collapse content collapse show" data-bs-parent="#accordion-group-1" id="accordion1-1">
                        <%--<h3 class="mb-0 mt-2 font-22">Direct Guarantee Approach</h3>--%>
                        <img src="~/images/Banner/LOA_1.jpg" runat="server" style="width: 100%; margin: 20px 0px 20px 0px;" />

                        <div class="row" id="step1">
                            <h4 class="tab-content">กรุณาระบุข้อมูลกิจการของท่าน</h4>
                            <div class="col-12">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-6">
                                            <a href="#" data-bs-dismiss="offcanvas" class="btn btn-s btn-full gradient-blue shadow-bg shadow-bg-xs" onclick="redirectToLOAStep2BK()">บุคคลธรรมดา</a>
                                        </div>
                                        <div class="col-6">
                                            <a href="#" data-bs-dismiss="offcanvas" class="btn btn-s btn-full gradient-gray shadow-bg shadow-bg-xs disabledButton" onclick="redirectToLOAStep2()">นิติบุคคล</a>
                                        </div>
