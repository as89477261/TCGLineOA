...
CodeBehind="index.aspx.cs" Inherits="CustomerHealthCheck.views.EventBanner.index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField runat="server" ID="hddRegisterbutton" ClientIDMode="Static"/>
    <asp:HiddenField runat="server" ID="hddCheckRegisterPartner" ClientIDMode="Static"/>
    ...
    <div class="page-content footer-clear" style="padding: 0px !important;">
        ...
        <div class="card card-style">
            ...
            <div class="card card-style">
                <img src="<%= ResolveClientUrl("~/images/Banner/BannerEvent1_5.jpg") %>"/>
                ...
                <div class="content pb-0">
                    ...
                    <div>
                        ...
                        <ul class="align-self-center me-auto">
                            ...
                            <%--<li>อัตราค่าบำรุงสมาชิกเพียง 500 บาท </li>--%>
                            <li>สิทธิพิเศษ ร้านค้า โรงแรม/ที่พัก ของฝาก คลินิกทันตกรรม และบริการ กว่า 2,000 รายการ</li>
                        </ul>
                    </div>
                </div>
                <div id="registerEventBanner" style="display : none">
                    <%--<a id="btnRegisterEventBanner" href="#" onclick="" class="btn btn-full mx-3 shadow-bg shadow-bg-s" text="ติดตามได้เร็วๆ นี้">Text</a>--%>
                    <input type="button"
                           value="ติดตามเร็วๆ นี้"
                           onclick="redirectToRegisterEventBanner()"
                           id="btnRegisterEventBanner"
                           class="btn btn-full rounded-s gradient-gray shadow-bg shadow-bg-s w-100 disabledButton"
                           data-bs-toggle="offcanvas"
                           data-bs-target="#menu-exchange">
                </div>

                <asp:Panel class="row" runat="server" ID="openRegister" Visible="false">
                    <div class="col-6">

                        <a href="#" class="btn-full btn-sm btn gradient-blue shadow-bg shadow-bg-m" onclick="redirectToRegisterEventBannerPersonal();">
                            ลงทะเบียน
                            <br/>
                            บุคคลธรรมดา
                        </a>
                    ...
                    <div class="col-6">
                        ...
                        <a href="#" class="btn-full btn-sm btn gradient-green shadow-bg shadow-bg-m" onclick="redirectToRegisterEventBannerJuristic();">
                            ลงทะเบียน
                            <br/>
                            นิติบุคคล
                        </a>
        ...
        <div runat="server" id="registerPartnerStatus" class="card card-style" style="padding-top: 10px" visible="true">
            <div class="content">
                <h4>ประวัติการลงทะเบียน</h4>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    <script src="<%= ResolveClientUrl("~/scripts/Page/EventBanner/EventBanner.js") + "?v=" + DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
</asp:Content>