<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="index_Mock.aspx.cs" Inherits="CustomerHealthCheck.views.Event.index" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>TCG OneStopService - Events Menu</title>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content footer-clear" style="padding: 0px !important;">
        ...
        <div class="card card-style">
            <div class="content">
                <h4 class="mb-0">ลงทะเบียนเข้าร่วมกิจกรรมกับ บสย
                </h4>
                <p>
            ...
            <div class="content mb-0" style="padding: 10px; margin: 5px !important; display: block;">

                <div class="accordion-item  border-fade-highlight border-bottom-0 rounded-top rounded-m">

                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordion008" aria-expanded="false">
                        <i class="bi bi-calendar-event  pe-3 font-30" style="color: blue;"></i>
                        <span class="font-600 font-16 color-theme">กิจกรรมรับคูปองกาแฟพันธ์ไทย</span>
                        <i class="bi bi-check-circle-fill font-20 color-green-dark"></i>
                    </button>

                    <div id="accordion008" class="accordion-collapse p-2 collapse" data-bs-parent="#accordion-group-7" style="">
                        <p style="margin-bottom: 0px; font-size: 120%;"> 
                            <span style="color: #3498DB"><label>กรอกแบบฟอร์มเบื้องต้นเพื่อลุ้นรับสิทธิ์ </label></span> 
                        </p>

                        <br>                       

                        <a href="/views/register/event/register004.aspx" id="btnRegis008" class="btn btn-full  gradient-blue shadow-bg shadow-bg-s ">เข้าร่วมกิจกรรม</a>
                    </div>
                </div>
            </div>

            <div class="content mb-0" style="padding: 10px; margin: 5px !important; display: none;">
                <%-- <div class="tabs tabs-pill" id="tab-group-2">
                    <div class="tab-controls rounded-m p-1">
                        <a class="font-13 rounded-m" data-bs-toggle="collapse" href="#tab-4" aria-expanded="true">กิจกรรม บสย.</a>
                        <a class="font-13 rounded-m" data-bs-toggle="collapse" href="#tab-5" aria-expanded="false">ประวัติการเข้าร่วม</a>
                    </div>


                    <div class="mt-3"></div>
                    <div class="collapse show" id="tab-4" data-bs-parent="#tab-group-2" style="padding:10px;">--%>
                <asp:Panel runat="server" ID="pnlEvent" Visible="false"></asp:Panel>
                <asp:Panel runat="server" ID="pnlEmpty" Visible="false">
                    <div class="row text-center">
                        <h3>ยังไม่มีการจัดกิจกรรม</h3>
                    </div>
                </asp:Panel>
                <%-- </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="justify-content: center;">
                    ...
                    <a href="#" data-bs-dismiss="modal" id="btnSuccessRegisterClose"
                        class="btn btn-sm mx-3 gradient-green shadow-bg shadow-bg-xs">เลือกกิจกรรมอื่น
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="justify-content: center;">
                    ...
                    <a href="#" data-bs-dismiss="modal" id="btnRegisteredClose"
                        class="btn btn-sm mx-3 gradient-green shadow-bg shadow-bg-xs">ปิด
                    </a>
                </div>
            </div>
        </div>
