<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Register004.aspx.cs" Inherits="CustomerHealthCheck.views.Register.Event.Register004" %>
...
<div class="page-content footer-clear" style="padding: 0px !important;">
    ...
    <div class="card card-style">
        ...
        <div class="content">
            <h4 class="mb-0">
                แบบฟอร์มลงทะเบียนเจ้าหน้าที่ บสย.
            </h4>
            <p>
                ...
                <div class="col-12">
                    <div class="content mt-0">
                        ...
                        <div class="form-custom form-label form-border mb-3 bg-transparent">
                            <input type="number" class="form-control rounded-xs" id="txtEmployeeCode" placeholder="โปรดระบุรหัสพนักงาน" maxlength="10" autocomplete="off">
                            <label for="txtEmployeeCode" class="color-highlight form-label-always-active">รหัสพนักงาน</label>
                            <span>(required)</span>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้าพเจ้ายืนยันว่าข้อมูลที่กรอก เป็นข้อมูลที่ถูกต้อง เพื่อใช้ในการลงทะเบียนเข้าร่วมกิจกรรม โดยเมื่อประกาศผลแล้ว ท่านสามารถตรวจสอบสิทธิ์ได้จากเมนู My Privilege
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/scripts/Page/Event/Register004.js") + "?v=" + DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
</asp:Content>