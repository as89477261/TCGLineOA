...
CodeBehind="Register003.aspx.cs" Inherits="CustomerHealthCheck.views.Register.Register003" %>
            ...
            <div class="row" id="step1">
                ...
                <div class="col-12">
                    <div class="content mt-0">
                        ...
                        <div class="form-custom form-label form-border mb-3 bg-transparent">
                            <input autocomplete="off" type="email" class="form-control rounded-xs" id="txtEmail" placeholder="โปรดระบุอีเมล">
                        ...
                        <div class="form-custom form-label form-border form-icon">
                            <i class="bi bi-calendar font-13"></i>
                            <label for="c6a" class="color-highlight form-label-always-active">เลือกธนาคารที่สนใจ</label>
                            <select class="form-select rounded-xs" id="ddlHaveMainBank" onchange="ToggleMainLoanBankValue();">
                                <option value="" selected="">- กรุณาเลือก -</option>
                                <option value="001">ธนาคารที่เข้าร่วมโครงการทั้งหมด</option>
                                <option value="002">เลือกเฉพาะธนาคาร (โปรดระบุ)</option>
                            </select>
                        </div>

                        <div id="divHaveMainBankSelectBank" class="form-custom form-label form-border form-icon" style="display: none;">
                            <i class="bi bi-calendar font-13"></i>
                            <label for="c6a" class="color-highlight form-label-always-active">โปรดระบุธนาคาร</label>
                            <asp:DropDownList CssClass="form-select rounded-xs" runat="server"
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/scripts/Page/Event/Register003.js") + "?v=" + DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
</asp:Content>