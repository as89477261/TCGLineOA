...
CodeBehind="Register002.aspx.cs" Inherits="CustomerHealthCheck.views.Register.Register002" %>
            ...
            <div class="row" id="step1">
                ...
                <div class="col-12">
                    <div class="content mt-0">
                        ...
                        <div class="form-custom form-label form-border mb-3 bg-transparent">
                            <input autocomplete="off" type="number" class="form-control rounded-xs" id="txtIDCard" placeholder="โปรดระบุรหัสบัตรประชาชน/เลขนิติบุคคล" maxlength="13">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/scripts/Page/Event/Register002.js") + "?v=" + DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
</asp:Content>