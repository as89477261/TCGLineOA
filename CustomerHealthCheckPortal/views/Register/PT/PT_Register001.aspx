...
CodeBehind="PT_Register001.aspx.cs" Inherits="CustomerHealthCheck.views.Register.PT_Register001" %>
            ...
            <div class="row" id="step1">
                ...
                <div class="col-12">
                    <div class="content mt-0">
                        <img src="http://localhost:56955/images/Banner/TedFundBanner.png" />
                        ...
                        <div class="form-custom form-label form-border mb-3 bg-transparent">
                         ...
                         <div class="form-custom form-label form-border form-icon">
                            ...
                            <label for="c6a" class="color-highlight form-label-always-active">สนใจรับบริการของ บสย. ด้านใด</label>
                            <select class="form-select rounded-xs" id="ddlHaveProgram" >
                                <option value="" selected="">- กรุณาเลือก -</option>
                                <option value="PGS11">เข้าถึงแหล่งทุนสินเชื่อพร้อมการค้ำประกัน โครงการ PGS 11</option>
                                <option value="FA">ปรึกษาแนะนำกับ หมอหนี้ บสย.</option>
                            </select>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/scripts/Page/PT/PT_Register001.js") + "?v=" + DateTime.Now.ToString("ddMMyyyyHHmmss") %>"></script>
</asp:Content>