...
CodeBehind="Index.aspx.cs" Inherits="CustomerHealthCheck.views.Register.Index" %>
            ...
            <div class="col-12">
                <div class="content mt-0">
                    ...
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtBusinessName" placeholder="โปรดระบุชื่อกิจการ">
                    ...
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtPosition" placeholder="โปรดระบุตำแหน่ง">
                        <label for="txtPosition" class="form-label-always-active color-highlight">ตำแหน่ง</label>
                        <span>(required)</span>
                    </div>
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="number" class="form-control rounded-xs" id="txtPhone" placeholder="โปรดระบุเบอร์มือถือ" maxlength="10">
                        <label for="txtPhone" class="color-highlight form-label-always-active">เบอร์มือถือ</label>
                        <span>(required)</span>
                    </div>
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="email" class="form-control rounded-xs" id="txtEmail" placeholder="โปรดระบุอีเมล์">
        ...
        <div class="row" id="step2" style="display: none;">
            <div class="col-12">
                <div class="content mt-0">
                    ...
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="number" class="form-control rounded-xs" id="txtCompanyAge" placeholder="โปรดระบุอายุกิจการ" maxlength="5" onkeyup="return numberMobile(event)">
                        <label for="txtCompanyAge" class="form-label-always-active color-highlight">อายุกิจการ</label>
                        <span>(required)</span>
                    </div>
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtIncomePerYear" placeholder="โปรดระบุยอดขายต่อปี" onkeyup="return numberMobile(event)">
                    ...
                    <%-- <div class="form-custom form-label form-border mb-3 bg-transparent">
                                <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtBranch" placeholder="โปรดระบุสาขา">
                    ...
                    <div class="form-custom form-label form-border mb-3 bg-transparent">
                        <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtLoanMoney" placeholder="โปรดระบุวงเงินสินเชื่อที่ต้องการ (บาท)" onkeyup="return numberMobile(event)">
                    ...
                    <div id="divHaveAssetGaranteeValue" class="form-custom form-label form-border mb-3 bg-transparent" style="display: none;">
                        <input autocomplete="off" type="text" class="form-control rounded-xs" id="txtHaveAssetGaranteeValue" placeholder="โปรดระบุหลักทรัพย์ค้ำประกัน">
