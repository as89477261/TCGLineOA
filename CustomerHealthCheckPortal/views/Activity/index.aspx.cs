    ...
    public partial class index : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                LogActivityCon.Instance.InsertFixObjAndMultitaskingLogActivity(BASE_UID, LogActivityCon.LogActivityEnum.History_Load);
            }
        }
        ...
        {
            var isEnableHealthCheckFeatureStatus = GetAppsetting("IsShowHealthCheckFeature");
            var isEnableProductFeatureStatus = "0";//GetAppsetting("IsShowTCGProductFeature");
            var isEnableDebtFeatureStatus = GetAppsetting("IsShowDebtRegisterFeature");
