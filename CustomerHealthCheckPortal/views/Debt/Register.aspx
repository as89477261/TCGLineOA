<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs"
    Inherits="CustomerHealthCheck.views.Debt.Register" %>
...
<%--                <div class="page-title d-flex">
                    <div class="align-self-center">
                        <a href="#" onclick="redirectToDebtStep1()"
            ...
            <div class="card card-style">
                <div class="content">
                    <h4 class="mb-0">แบบฟอร์มลงทะเบียน (2/2)
                    </h4>
                    <p>
                    ...
                    <div class="row">
                        <asp:Panel class="col-6" runat="server" ID="pnlPersonal" Visible="false">
                            ...
                            <a href="#" class="btn-full btn-sm btn gradient-blue shadow-bg shadow-bg-m" onclick="BindingPersonal();">ตั้งต้นด้วยข้อมูล
                        <br />
                                บุคคลธรรมดา
                            </a>
                        ...
                        <asp:Panel class="col-6" runat="server" ID="pnlJuristic" Visible="false">
                            ...
                            <a href="#" class="btn-full btn-sm btn gradient-green shadow-bg shadow-bg-m" onclick="BindingJuristic();">ตั้งต้นด้วยข้อมูล
                        <br />
                                นิติบุคคล
                            </a>
                        ...
                        <div class="col-12">
                            ...
                            <div class="content mt-0">
                                ...
                                <div class="form-custom form-label form-border form-icon">
                                    ...
                                    <select class="form-select rounded-xs" id="ddlTitle">
                                        <option value="" selected="">- กรุณาเลือก -</option>
                                        <option value="001" selected="">นาย</option>
                                ...
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    <input type="number" class="form-control rounded-xs" id="txtIDCard" placeholder="โปรดระบุรหัสบัตรประชาชน/เลขนิติบุคคล" maxlength="13" autocomplete="off">
                                    <label for="txtIDCard" class="form-label-always-active color-highlight">รหัสบัตรประชาชน/เลขนิติบุคคล</label>
                                    <span>(required)</span>
                                </div>
                                <div class="form-custom form-label form-border form-icon">
                                    <i class="bi bi-calendar font-13"></i>
                                    ...
                                    <select class="form-select rounded-xs" id="ddlBusinessPosition">
                                        <option value="" selected="">- กรุณาเลือก -</option>
                                        <option value="1" selected="">เจ้าของกิจการ</option>
                                ...
                                <div class="form-custom form-label form-border mb-3 bg-transparent">
                                    ...
                                    <label for="ddlPhone" class="color-highlight form-label-always-active">เบอร์มือถือ</label>
                                    <span>(required)</span>
                                </div>
                                ...
                                <a href="#" onclick="OpenConfirmRegisterDebt();" id="btnSubmit"
                                    class="btn btn-full gradient-highlight shadow-bg shadow-bg-s mt-4 btn-disable">บันทึก
        ...
        <div class="modal fade" id="ConfirmRegisterModalDebt" aria-hidden="true" aria-labelledby="ConfirmRegisterModalDebt" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="justify-content: center;">
                    ...
                    <a href="#" data-bs-target="#ConfirmRegisterModalDebt" data-bs-toggle="modal" data-bs-dismiss="modal"
                        class="btn btn-sm mx-3 gradient-blue shadow-bg shadow-bg-xs">ยกเลิก
                    </a>

                    <a href="#" onclick="KeepDataAndGoFinish()" data-bs-toggle="modal" data-bs-dismiss="modal"
        ...
        <div class="modal fade" id="FinishModal" aria-hidden="true" aria-labelledby="FinishModal" tabindex="-1" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="FinishModalLabel">เสร็จสิ้น</h5>
                        <%-- <button type="button" onclick="redirectToMain()" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>--%>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ระบบบันทึกการลงทะเบียนของท่านเป็นที่เรียบร้อย
                    <%--หากมีข้อเสนอแนะและข้อคิดเห็นเพิ่มเติม คลิก--%>
                    </div>
                    <div class="modal-footer" style="justify-content: center;">
                        <%--<a href="#" onclick="redirectToContactUs()" data-bs-toggle="modal" data-bs-dismiss="modal" class="btn btn-full mx-3 gradient-blue shadow-bg shadow-bg-xs">ข้อเสนอแนะ</a>--%>
                        <a href="#" data-bs-target="#FinishModal" data-bs-toggle="modal" data-bs-dismiss="modal"
                            class="btn btn-sm mx-3 gradient-blue shadow-bg shadow-bg-xs" onclick="redirectToMain();">กลับสู่หน้าหลัก</a>
                    </div>
                </div>
            </div>
        </div>
