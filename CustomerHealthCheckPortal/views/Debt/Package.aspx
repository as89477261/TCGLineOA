<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Package.aspx.cs" Inherits="CustomerHealthCheck.views.Debt.Package" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>TCG OneStopService - Debt Package</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="page">
        <div class="page-content footer-clear" style="padding: 0px !important;">
            ...
            <asp:Panel runat="server" ID="pnlChoosePackage">

                <div class="card card-style">
                    <div class="content">
                        <h4 class="mb-0">โครงการประนอมหนี้กับ บสย. (1/2)
                        </h4>
                        <p>
                                ...
                                <table class=" color-theme mb-2" style="margin-left: 20px;">
                                    ...
                                    <tbody>
                                        <tr class="border-fade-blue">
                                            ...
                                            <td>ศักยภาพชำระหนี้ต่ำ</td>
                                        </tr>
                                        <tr class="border-fade-blue">
                                            <td class="text-center">
                                                <i class="bi bi-check-circle-fill color-green-dark"></i>
                                            </td>
                                            <td>ไม่มีชำระเงินก้อน</td>
                                        </tr>
                                        <tr class="border-fade-blue">
                                        ...
                                        <tr class="border-fade-blue">
                                            ...
                                            <td>ค่างวดขั้นต่ำ 500 บาท</td>
                                        </tr>
                                        <tr class="border-fade-blue">
                                            <td class="border-0 text-center">
                                                <i class="bi bi-check-circle-fill color-green-dark"></i>
                                            </td>
                                            <td>สิ้นสุด ธ.ค.2567</td>
                                        </tr>
                                ...
                                <table class=" color-theme mb-2" style="margin-left: 20px;">
                                    <tbody>
                                        <tr class="border-fade-blue">
                                            ...
                                            <td>ศักยภาพชำระหนี้พอมี</td>
                                        </tr>
                                        <tr class="border-fade-blue">
                                            <td class="border-0 text-center">
                                                <i class="bi bi-check-circle-fill color-green-dark"></i>
                                            </td>
                                            <td>ชำระเงินก้อน 1% 3% 7%</td>
                                        </tr>
                                        <tr class="border-fade-blue">
                                            <td class="border-0 text-center">
                                                <i class="bi bi-check-circle-fill color-green-dark"></i>
                                            </td>
                                            <td>อัตรา ดบ.4.05% 2.05% 1.05%</td>
                                        </tr>
                                        <tr class="border-fade-blue">
                                            <td class="border-0 text-center">
                                                <i class="bi bi-check-circle-fill color-green-dark"></i>
                    ...
                    <asp:Panel runat="server" ID="pnlChoosePackageTopUp"></asp:Panel>

                </div>
            </asp:Panel>

            <asp:Panel runat="server" ID="pnlChoosedNotShowChoice">
                <div class="card card-style">
                    <div class="content">
                        <h4 class="mb-0">โครงการประนอมหนี้ที่ท่านเลือก คือ
                        </h4>
                        <p></p>
                    </div>
                    <div class="accordion accordion-m border-0 p-1" id="accordion-group-2">

                        <div class="accordion-item  border-fade-highlight border-bottom-0 rounded-top rounded-m" runat="server" id="divPackage1" visible="false">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-2">
                                <i class="bi bi-1-square-fill color-violet-dark pe-3 font-30" style="color: white;"></i>
                                <span class="font-600 font-18 color-violet-dark">มาตรการที่ 1</span>
                            ...
                            <div id="accordion2-1" class="accordion-collapse collapse p-2 show" data-bs-parent="#accordion-group-7">
                                <table class=" color-theme mb-2" style="margin-left: 20px;">
                        ...
                        <div class="accordion-item  border-fade-highlight border-bottom-0" runat="server" id="divPackage2" visible="false">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordionggg1-2">
                                <i class="bi bi-2-square-fill color-yellow-dark pe-3 font-30" style="color: white;"></i>
                                <span class="font-600 font-18  color-yellow-dark">มาตรการที่ 2</span>

                            </button>
                            <div id="accordionggg2-2" class="accordion-collapse collapse p-2 show" data-bs-parent="#accordion-group-7">
                                <table class=" color-theme mb-2" style="margin-left: 20px;">
                                    <tbody>
                                        <tr class="border-fade-blue">
                                            <td class="text-center">
                        ...
                        <div class="accordion-item  border-fade-highlight border-bottom-0" runat="server" id="divPackage3" visible="false">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordionggg1-3">
                                <i class="bi bi-3-square-fill color-green-dark pe-3 font-30" style="color: white;"></i>
                                <span class="font-600 font-18 color-green-dark">มาตรการที่ 3</span>

                            </button>
                            <div id="accordionggg2-3" class="accordion-collapse collapse p-2 show" data-bs-parent="#accordion-group-7">
                                <table class=" color-theme mb-2" style="margin-left: 20px;">
                                    <tbody>
                                        <tr class="border-fade-blue">
                                            <td class="text-center">
                        ...
                        <div style="padding: 10px 20px;">
                            ...
                            <h5>
                                <span>สถานะ : </span>
                                <asp:Literal ID="ltlDebtStatus" Text="" runat="server" />
                            </h5>

                        </div>
                        <div style="padding: 0px 20px;">
                            <span>สามารถติดต่อ บสย. ได้ที่ช่องทางศูนย์ที่ปรึกษาทางการเงิน SMEs (บสย. F.A.Center) Email: debt.doctor@tcg.or.th โทรศัพท์: 0-2890-9999
                            </span>
                        </div>
                    </div>
                    <asp:Panel runat="server" ID="pnlChooseNotShowChoiceTopUp"></asp:Panel>
        ...
        <div class="modal fade" id="ConfirmTopUpModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ConfirmTopUpModalLabel">ยืนยันเข้าร่วมโครงการ</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ท่านต้องการยืนยันเข้าร่วมมาตรการลูกหนี้ บสย. ผ่อนน้อย เบาแรง หรือไม่
                    </div>
                    <div class="modal-footer" style="justify-content: center;">
                        <button type="button" class="btn  mx-3 gradient-blue shadow-bg shadow-bg-xs" data-bs-dismiss="modal">ปิด</button>
                        <a href="#" data-bs-target="#ConfirmTopUpModal" data-bs-toggle="modal" data-bs-dismiss="modal"
                            class="btn btn-sm mx-3 gradient-green shadow-bg shadow-bg-xs" onclick="RegisterUIDMapDebtEvent();">ยืนยัน
                        </a>
                    </div>
                </div>
            </div>
