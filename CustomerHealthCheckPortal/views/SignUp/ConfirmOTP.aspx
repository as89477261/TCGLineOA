<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Step.Master" AutoEventWireup="true" CodeBehind="ConfirmOTP.aspx.cs" Inherits="CustomerHealthCheck.views.SignUp.ConfirmOTP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content footer-clear" style="padding: 0px !important;">
        ...
        <div class="card card-style px-2 py-2" id="pnlConfirmOTP">
            <div class="content">
                ...
                <div class="form-custom mb-1">
                    ...
                    <select class="form-select rounded-xs" id="ddlSMSPhoneNumber">
                        <option value="0829995156" selected="">XXX-XXX-X156</option>
                    </select>
                </div>

                <div class="mb-5" style="text-align: center;">
                    <a href="#" id="btnSendOTP" onclick="SendOTP();"
                       class="btn btn-full mx-1 gradient-blue shadow-bg shadow-bg-xs ">
                        ขอรหัส OTP
                    </a>
                </div>
                ...
                <div id="pnlKeyInOTP" style="display: none;">
                    <div class="form-custom form-label form-border form-icon mb-1 bg-transparent">
                        ...
                        <input type="text" class="form-control rounded-xs font-18" id="txtOTP" placeholder="โปรดระบุรหัส OTP" maxlength="6">
                    ...
                    <a href="#" onclick="ShowModalSubmitOTP()" class="btn btn-full gradient-highlight shadow-bg shadow-bg-s mt-4">ยืนยันรหัส OTP</a>
