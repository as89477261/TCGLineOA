<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="index_buffer.aspx.cs"
Inherits="CustomerHealthCheck.views.RequestInfo.index_buffer" %>
            ...
            <div class="content mb-0">
                <div class="tabs tabs-pill" id="tab-group-2">
                    ...
                    <div class="tab-controls rounded-m p-1 overflow-visible" style="background: silver; text-align: center;">
                        ...
                        <a class="font-13 rounded-s py-1 shadow-bg shadow-bg-s tabCustomBar" data-bs-toggle="collapse"
                           href="#tab-5" aria-expanded="true">
                            ยืนยันรายการคำขอ (<asp:Literal Text="" ID="lblCountWaitingItem" runat="server"/>)
                        </a>
                        <a class="font-13 rounded-s py-1 shadow-bg shadow-bg-s tabCustomBar" data-bs-toggle="collapse"
                           href="#tab-6" aria-expanded="false">
                            ประวัติทำรายการ (<asp:Literal Text="" ID="lblCountFinishItem" runat="server"/>)
                        </a>
...
<div class="modal fade" id="ChooseBankNDIDModal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1" data-bs-backdrop="static">
