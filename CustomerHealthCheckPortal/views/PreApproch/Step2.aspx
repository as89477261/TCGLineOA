<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Step.Master" AutoEventWireup="true" CodeBehind="Step2.aspx.cs" Inherits="CustomerHealthCheck.views.PreApproch.Step2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content footer-clear" style="padding:0px !important">
        ...
        <asp:Panel runat="server" ID="pnlHasItem" Visible="false">
            <div class="card card-style">
                <div class="content" style="margin-top: 5px !important;">
                    <h3 class=" pt-1 pb-1 color-black">เลือกข้อมูลสุขภาพทางการเงิน</h3>
                    <label class="opacity-30">เพื่อใช้เป็นข้อมูลตั้งต้นให้ บสย.</label>
                    ...
                    <div class="collapse show" id="tab-4" data-bs-parent="#tab-group-2">
                        ...
                        <div class="divider my-2 opacity-50"></div>
                        <label style="color: red;">**กรุณาเลือกข้อมูลที่ถูกต้อง เพื่อความรวดเร็วในการพิจารณา</label>
                        <label style="color: red;">**ผลการตรวจสุขภาพทางการเงินมีอายุ 14 วัน นับจากวันที่ทำแบบทดสอบ</label>
                    </div>
                </div>
            </div>
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="pnlEmpty">
            <div class="card card-style">
                <div class="content" style="margin-top: 5px !important;">
                    <h3 class=" pt-1 pb-1 color-black" style="text-align:center;">รายการตรวจสุขภาพทางการเงิน</h3>

                    <div class="divider mb-0"></div>
                    <div class="collapse show" data-bs-parent="tab-group-2" style="text-align:center;margin-top:10px;">
                        <p class="color-black opacity-50">ยังไม่มีประวัติการตรวจสุขภาพทางการเงิน</p>


                        <a href="#" class="btn btn-xs gradient-green shadow-bg-m text-start" style="border-radius:50px;" onclick="redirectToHealthCheck()">
                            <i class="bi bi-plus-circle " style="font-size:32px !important;"></i>
                        </a>
                    </div>
                </div>
            </div>
