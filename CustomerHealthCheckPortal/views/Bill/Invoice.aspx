<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="CustomerHealthCheck.views.Bill.Invoice" %>
        ...
        <div class="card card-style">
            <div class="content">
                <div class="d-flex">
                    ...
                    <div class="ms-auto">
                        <img src="images/pictures/31s.jpg" width="60" class="rounded-m shadow-xl">
                    </div>
                </div>
                ...
                <div class="row mb-3 mt-4">
                    ...
                    <h5 class="col-8 text-end font-14 font-400">
                        <span class="bg-green-dark px-2 rounded-s">Paid</span>
                    </h5>
                ...
                <div class="d-flex mb-4">
                    <div>
                        <img src="images/pictures/14s.jpg" width="110" class="rounded-s shadow-xl">
                    </div>
                ...
                <div class="d-flex mb-0">
                    <div>
                        <h5 class="opacity-50 font-500">Taxes</h5>
                    </div>
                    <div class="ms-auto">
                        <h5>$30 </h5>
                    </div>
