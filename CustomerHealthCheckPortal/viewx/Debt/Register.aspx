...
Inherits="CustomerHealthCheck.viewx.Debt.Register" %>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="content mt-0">
                        ...
                        <div class="form-custom form-label form-border mb-3 bg-transparent">
                            <input type="number" class="form-control rounded-xs" id="txtIDCard" placeholder="โปรดระบุรหัสบัตรประชาชน/เลขนิติบุคคล" maxlength="13">
                        ...
                        <div class="form-custom form-label form-border mb-3 bg-transparent">
                            <input type="text" class="form-control rounded-xs" id="txtBusinessName" placeholder="โปรดระบุชื่อกิจการ/บริษัท">
                        ...
                        <a href="#" onclick="OpenFinishModal();"
