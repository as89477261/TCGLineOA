...
Inherits="CustomerHealthCheck.viewx.Bill.index" %>
...
<div class="pt-3">
    <div class="page-title d-flex">
        <div class="align-self-center me-auto">
            <h2 class="color-white" style="color: #092d74 !important;">รายการชำระเงิน </h2>
        </div>
    ...
    <div class="content mb-0">
        <div class="tabs tabs-pill" id="tab-group-2">
            <div class="tab-controls rounded-m p-1 overflow-visible">
                <a class="font-13 rounded-s py-1 shadow-bg shadow-bg-s" data-bs-toggle="collapse" href="#tab-4" aria-expanded="true">รายการที่ต้องชำระ</a>
                <a class="font-13 rounded-s py-1 shadow-bg shadow-bg-s" data-bs-toggle="collapse" href="#tab-5" aria-expanded="false">ใบเสร็จการชำระเงิน</a>
            </div>
            <div class="mt-3"></div>
            <!-- Tab Bills List -->
            <div class="collapse show" id="tab-4" data-bs-parent="#tab-group-2">
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 4</h5>
                        <p class="mb-0 font-11 opacity-70">12/04/2565</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-red-light">ค้างชำระ</p>
                    </div>
                </a>
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 3</h5>
                        <p class="mb-0 font-11 opacity-70">12/03/2565</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-green-light">ชำระแล้ว</p>
                    </div>
                </a>
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 2</h5>
                        <p class="mb-0 font-11 opacity-70">12/02/2565</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-green-light">ชำระแล้ว</p>
                ...
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 1</h5>
                        <p class="mb-0 font-11 opacity-70">12/01/2565</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-green-dark">ชำระแล้ว</p>
                    </div>
                </a>
            </div>
            ...
            <div class="collapse" id="tab-5" data-bs-parent="#tab-group-2">
                ...
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill-paid" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 3</h5>
                        <p class="mb-0 font-11 opacity-70">12/03/2563</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-green-light">ชำระแล้ว</p>
                ...
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill-paid" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 2</h5>
                        <p class="mb-0 font-11 opacity-70">12/02/2563</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-green-light">ชำระแล้ว</p>
                ...
                <a href="#" data-bs-toggle="offcanvas" data-bs-target="#menu-bill-paid" class="d-flex py-1 mb-2">
                    <div class="align-self-center">
                        <h5 class="pt-1 mb-n1">รอบชำระเงิน งวดที่ 1</h5>
                        <p class="mb-0 font-11 opacity-70">12/01/2563</p>
                    </div>
                    <div class="align-self-center ms-auto text-end">
                        <h4 class="pt-1 mb-n1">442,000 บาท</h4>
                        <p class="mb-0 font-11 color-green-dark">ชำระแล้ว</p>
...
<div id="menu-bill"
    ...
    <div class="menu-size" style="height: 670px;">
        <div class="d-flex mx-3 mt-3 py-1">
            <div class="align-self-center">
                <h3 class="mb-0">รายการชำระ งวดที่ 1</h3>
            </div>
        ...
        <div class="content mt-0">
            <div class="row mb-3 mt-4">
                <h5 class="col-5 text-start font-15">รหัสใบสั่งจ่าย</h5>
                ...
                <h5 class="col-7 text-end font-14 font-400">
                    <span class="bg-green-dark px-2 rounded-s">12/01/2565</span>
                </h5>
                <h5 class="col-5 text-start font-15">รหัสหนังสือคํ้าประกัน</h5>
                <h5 class="col-7 text-end font-14 opacity-60 font-400">66-00XXXX1</h5>
                ...
                <h5 class="col-7 text-end font-14 opacity-60 font-400">442,000 บาท</h5>
            </div>
            <div class="row" style="text-align:center;">
                <h4>QR Code</h4>
                <img src="../../images/QR/QR.jpg" style="width:50%;margin:0 auto;"/>
            </div>
            <div class="row" style="text-align:center;">
                <h4>Barcode</h4>
                <img src="../../images/QR/barcode.jpg" style="width:70%;height:80px;margin:0 auto;"/>
            </div>
        </div>
        <a href="#" data-bs-dismiss="offcanvas" class="mx-3 btn btn-full gradient-blue shadow-bg shadow-bg-s mb-3">ดาวน์โหลดใบสั่งจ่าย</a>
    </div>
</div>
