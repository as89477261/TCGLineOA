<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CustomerHealthCheck.V2.Default" %>
        ...
        <form action="Default.aspx" id="formRegister" name="formRegister" runat="server">
            ...
            <div id="modalResult" class="modal" runat="server">
                <div class="modal-window">
                    ...
                    <h3>
                        <asp:Label ID="lblSaveSuccess" runat="server" Text="บันทึกข้อมูลสำเร็จ <br/>เจ้าหน้าที่จะติดต่อท่านภายใน 2 วันทำการครับ" Visible="False"></asp:Label>
