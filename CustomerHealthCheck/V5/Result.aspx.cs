...
namespace CustomerHealthCheck.V5
{
            ...
            try
            {
                ...
                if (Session["RegisterInfo"] != null && Session["ScoreInfo"] != null)
                {
                    ...
                    if (Session["uid"] != null && registerInfoId != 0) {
                        ...
                        try
                        {
							var configSendEmailPhomKhum = GetAppsetting("sendMailPromKhum").ToString();

							//var configSendEmailPhomKhum = ConfigurationManager.AppSettings["sendMailPromKhum"];

							if (configSendEmailPhomKhum == "Y")
                            {
                            ...
                            {
                                LocalLogManager.Logger("NoSendMail"); 
