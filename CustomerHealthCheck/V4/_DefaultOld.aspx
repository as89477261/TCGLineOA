<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="_DefaultOld.aspx.cs" Inherits="CustomerHealthCheck.V4._DefaultOld" %>
...
<body>
    <div class="wrapper">
        <div class="image-holder">
            ...
            <asp:Image ImageUrl="~/images/PromKhum_1.png" runat="server" alt="" class="noPrint" Style="padding: 5px;" />
            ...
            <div id="wizard2">
                ...
                <section id="divStep1" style="display: block; padding: 20px;">
                    ...
                    <div class="form-row">
                        ...
                        <asp:TextBox ID="txtYearIncorporate" runat="server" class="form-control" placeholder="ระบุจำนวนปีตั้งแต่ก่อตั้งกิจการมา"></asp:TextBox>
                    </div>
                    <div class="form-row">
                ...
                <section id="divStep2" style="display: none;">
                    <div class="form-row">
                        ...
                        <asp:TextBox ID="txtOwnerAge" runat="server" class="form-control" placeholder="ระบุจำนวนปี"></asp:TextBox>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <asp:TextBox ID="txtYearExperience" runat="server" class="form-control" placeholder="ระบุจำนวนปี"></asp:TextBox>
                    </div>
                ...
                <section id="divStep3" style="display: none;">
                    ...
                    <div id="divTDR" class="form-row form-group" style="display: none;">
                        <div class="form-holder">
                            ...
                            <asp:TextBox ID="txtTdrAmount" runat="server" class="form-control" placeholder="ระบุตัวเลข"></asp:TextBox>
                        </div>
                        <div class="form-holder">
                ...
                <section id="divStep5" style="display: none;">
                    ...
                    <div class="form-row">
                        ...
                        <asp:TextBox ID="txtInstallmentYear" runat="server" class="form-control" placeholder="ระบุจำนวนเงินเป็นตัวเลข"></asp:TextBox>
                    </div>
                    <div class="form-row">
