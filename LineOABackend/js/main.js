...
$(document).ready(function () {
    ...
    if (header.length > 0) {
        $('.mainheight').css({ 'min-height': Number(maincontentheight - header.outerHeight()), 'margin-top': header.outerHeight() });
    ...
    if (footer.length > 0) {
        $('.mainheight').css('min-height', Number(maincontentheight - footer.outerHeight()));
...
$(window).on('load', function () {
    ...
    if (header.length > 0 && footer.length > 0) {
        setTimeout(function () {
            $('.mainheight').css({ 'min-height': maincontentheight - header.outerHeight() - footer.outerHeight() });
        }, 100)
    }
...
$(window).on('resize', function () {
    ...
    if (header.length > 0) {
        ...
        $('.mainheight').css({ 'min-height': maincontentheight, 'margin-top': header.outerHeight() });
