...
namespace CustomerHealthController
{
    class Personal
    {
        ...
        public int scoreMaritalStatus(MaritalType key)
        {
            ...
            switch (key)
            {
                case MaritalType.NoShow: score = 103; break; /* ไม่ระบุ */
                case MaritalType.Single: score = 119; break; /* โสด */
                case MaritalType.Divorce: score = 119; break; /* หย่าร้าง */
                case MaritalType.Widow: score = 119; break; /* หม้าย */
                case MaritalType.Married: score = 136; break; /* สมรส */
            }
            return score;
        }
