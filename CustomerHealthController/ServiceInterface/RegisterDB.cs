...
namespace CustomerHealthController
{
    public class RegisterDB
    {
        ...
        Database DB_SMEClinic = new Database(Database.DBName.DB_SMEClinic);
        ...
        public int GetBucketProvince(string ProvinceCode, PersonType type)
        {
            ...
            try
            {
                object result = DB_CustomerHealthCheck.executeStoredProcedureScalar("GetBucketProvince", parameters);
                ...
                {
                    Utility.writeLog("GetBucketProvince() : There is no data from GetBucketProvince", ref log4);
                }
            }
            catch (Exception ex)
            {
                Utility.writeLog("GetBucketProvince Error : " + ex.ToString(), ref log4);
            }
        ...
        public DataTable GetIndustry()
        {
            ...
            {
                Utility.writeLog("GetIndustry Error : " + ex.ToString(), ref log4);
            }
        ...
        public int GetBucketIndustry(string IndustryGroup, PersonType type)
        {
            ...
            try
            {
                object result = DB_CustomerHealthCheck.executeStoredProcedureScalar("GetBucketIndustry", parameters);
                ...
                {
                    Utility.writeLog("GetBucketIndustry() : There is no data from GetBucketIndustry", ref log4);
                }
            }
            catch (Exception ex)
            {
                Utility.writeLog("GetBucketIndustry Error : " + ex.ToString(), ref log4);
            }
        ...
        public DataTable GetFieldName(int FieldGroupId)
        {
            ...
            {
                Utility.writeLog("GetFieldName Error : " + ex.ToString(), ref log4);
            }
        ...
        public ScoreInfo GetHealthCheckScore(ScoreInfo score, PersonType type)
        {
            ...
            try
            {
                DataTable dt = DB_CustomerHealthCheck.ExecuteStoredProcedureReturnDataSet("GetHealthCheckScore", parameters).Tables[0];
            ...
            {
                Utility.writeLog("GetHealthCheckScore Error : " + ex.ToString(), ref log4);
            }
        ...
        public int InsertRegisterInfo(RegisterInfo info, ScoreInfo score)
        {
            ...
            SqlParameter[] parameters =
            {
                  ...
                  new SqlParameter("@IsGetProfit", SqlDbType.Int) { Value = info.isGetProfit == IsGetProfit.Yes ? 1 : info.isGetProfit == IsGetProfit.No ? 2 : 0 },
                  ...
                  new SqlParameter("@TCGScoreTotalScore", SqlDbType.Decimal) { Value = info.TCGScoreTotalScore },
                  new SqlParameter("@TCGScoreScoreBand", SqlDbType.Decimal) { Value = info.TCGScoreScoreBand }
            };

            try
            {
                object result = DB_CustomerHealthCheck.executeStoredProcedureScalar("InsertRegisterInfo", parameters);
                ...
                {
                    Utility.writeLog("InsertRegisterInfo() : There is no data from InsertRegisterInfo", ref log4);
                }
            }
            catch (Exception ex)
            {
                Utility.writeLog("InsertRegisterInfo Error : " + ex.ToString(), ref log4);
            }
            return id;
        }
        ...
        public bool UpdateRegisterInfo(RegisterInfo info)
        {
            ...
            {
                Utility.writeLog("UpdateRegisterInfo Error : " + ex.ToString(), ref log4);
            }
            return false;
        }
        ...
        public bool UpdateConsent(RegisterInfo info)
        {
            ...
            {
                Utility.writeLog("UpdateConsent Error : " + ex.ToString(), ref log4);
            }
            return false;
        }
        ...
        public bool UpdateCodeFromClinic(int id, string clinicCustomerCode, string clinicRequestNo)
        {
            ...
            {
                Utility.writeLog("UpdateCodeFromClinic Error : " + ex.ToString(), ref log4);
            }
            return false;
        }
        ...
        public string InsertCustomerProfile(RegisterInfo info)
        {
            ...
            {
                /* from user input */                
                new SqlParameter("@Name", SqlDbType.VarChar, 100) { Value = String.IsNullOrEmpty(info.name) ? info.businessName : info.name },
                new SqlParameter("@SureName", SqlDbType.VarChar, 100) { Value = String.IsNullOrEmpty(info.surname) ? "" : info.surname},
                ...
                new SqlParameter("@IsCurrentAddressOfHouse", SqlDbType.Bit) { Value = true },
                new SqlParameter("@User_Create", SqlDbType.VarChar, 15) { Value = "9991" }
            };

            try
            {
                customerCode = DB_SMEClinic.executeStoredProcedureScalar("proc_InsertCustomerProfile", parameters).ToString();
            }
            catch (Exception ex)
            {
                Utility.writeLog("InsertCustomerProfile() Error : " + ex.ToString(), ref log4);
            }
        ...
        public void InsertContactProfile(RegisterInfo info, string customerCode, int ContactType)
        {
            ...
            {
                Utility.writeLog("InsertContactProfile() Error : " + ex.ToString(), ref log4);
            }
        }
        ...
        public string InsertRequest(string customerCode, int Activity_Id)
        {
            ...
            {
                Utility.writeLog("InsertRequest() Error : " + ex.ToString(), ref log4);
            }
        ...
        public void InsertFieldData(string MasterData_KeyId, int FieldInfo_Id, string FieldValue)
        {
            ...
            {
                Utility.writeLog("InsertFieldData() Error : " + ex.ToString(), ref log4);
            }
        }
        ...
        public bool UpdateUID(string uid, string customerProfileCode)
        {
            ...
            {
                Utility.writeLog("UpdateUID Error : " + ex.ToString(), ref log4);
            }
            return false;
        }

        public bool InsertUIDRegisterInfo(string uid, int registerInfoId)
        {
            SqlParameter[] parameters =
            {
                  new SqlParameter("@UID", SqlDbType.VarChar) { Value = uid },
            ...
            {
                Utility.writeLog("InsertUIDRegisterInfo Error : " + ex.ToString(), ref log4);
            }
            return false;
        }
    }
