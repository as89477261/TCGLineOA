    ...
    class Database
    {
        ...
        public Database(DBName DbName)
        {
            switch (DbName)
            {
                ...
                case DBName.DB_SMEClinic:
                    ConnectionString = ConfigurationManager.AppSettings["DB_SMEClinic"].ToString();
                    break;
        ...
        public int ExecuteStoredProcedureNonQuery(string StoredProcedureName)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in ExecuteStoredProcedureNonQuery() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return checkValue;
        }
        ...
        public int ExecuteCommandTextNonQuery(string CommandText)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in ExecuteCommandTextNonQuery() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return checkValue;
        }
        ...
        public int ExecuteStoredProcedureNonQueryBulk(string StoredProcedureName, SqlParameter[][] parameters)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in ExecuteStoredProcedureNonQueryBulk() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return checkValue;
        }
        ...
        public Object executeStoredProcedureScalar(string StoredProcedureName)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in executeStoredProcedureScalar() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return returnValue;
        }
        ...
        public Object ExecuteCommandTextScalar(string CommandText)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in ExecuteCommandTextScalar() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return returnValue;
        }
        ...
        public bool executeStoredProcedureHasRow(string StoredProcedureName)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in executeStoredProcedureHasRow() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return checkValue;
        }
        ...
        public bool ExecuteCommandTextHasRow(string CommandText)
        {
            ...
            using (connectToDB)
            {
                ...
                {
                    throw new Exception("Error in ExecuteCommandTextHasRow() OF DatabaseAccess.cs" + err.ToString());
                }
            }
            return checkValue;
        }
