...
namespace OIC_UTILITY
{
    ...
    {
        /// Sends an Email.
        public static bool Send(string sender, string senderName, string recipient, string recipientName,
        ...
        public static void SendAsync(string sender, string senderName, string recipient, string recipientName,
            string subject, string body)
        {
            var message = new MailMessage
            {
