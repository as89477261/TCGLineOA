...
namespace Utility.DataAnnotaion
{
    public class PhoneValidateField : ValidationAttribute
    {
        public const string errorMessage = "Phone number is wrong format";
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (!DateTime.TryParse(valueString, out var dob))
